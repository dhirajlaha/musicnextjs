  ...
  return (
    <div className="dark:text-white py-12 bg-gray-900">
      ...
      <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
        {featuredCourses.map((course) => (
          <div key={course.id} className="flex justify-center">
            <BackgroundGradient className="rounded-[22px] overflow-hidden h-full flex flex-col max-w-sm bg-white dark:bg-zinc-900">
      ...
      <div className="mt-20 text-center">
        <Link
          href={"/courses"}
          className="px-4 py-2 border border-neutral-600 bg-white text-neutral-700 rounded 
